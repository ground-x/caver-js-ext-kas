...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.FDUserContractDeployTransactionRequest = factory(root.WalletApi.ApiClient)
    }
     ...
     */
    const FDUserContractDeployTransactionRequest = function(from, input, feePayer) {
        this.from = from
        this.input = input
    ...
    return FDUserContractDeployTransactionRequest
})
