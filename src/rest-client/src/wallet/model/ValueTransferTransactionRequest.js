...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.ValueTransferTransactionRequest = factory(root.WalletApi.ApiClient)
    }
     ...
     */
    const ValueTransferTransactionRequest = function(from, value, to) {
        this.from = from
        this.value = value
        this.to = to
    }
    ...
    return ValueTransferTransactionRequest
})
