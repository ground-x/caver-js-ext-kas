...
class CallArgument {
     ...
     * @alias CallArgument
     * @class
     * @param type {String} ABI types. Valid types are `uint256`, `uint32`, `string`, `bool`, `address`, `uint64[2]`, `address[]`.
     * @memberof CallArgument
     * @param value {Object} Parameter value. Valid types are `number`, `string`, `array`, `boolean`.
     */
