...
;(function(root, factory) {
     ...
     * @alias CallArgument
     * @class
     * @param type {String} ABI types. For example `uint256`, `uint32`, `string`, `bool`, `address`, `uint64[2]` and `address[]` can be used
     * @memberof CallArgument
     * @param value {Object} parameter value. `number`, `string`, `array` and `boolean` value type can be used
     */
