...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.RoleBasedUpdateKeyType = factory(root.WalletApi.ApiClient)
    }
    ...
    RoleBasedUpdateKeyType.constructFromObject = function(data, obj) {
        if (data) {
            obj = obj || new RoleBasedUpdateKeyType()
            if (data.hasOwnProperty('keyType')) obj.keyType = ApiClient.convertToType(data.keyType, 'Number')
            if (data.hasOwnProperty('key')) obj.key = ApiClient.convertToType(data.key, [Object])
        }
        return obj
    }
