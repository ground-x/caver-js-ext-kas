...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.FDUserValueTransferTransactionRequest = factory(root.WalletApi.ApiClient)
    }
})(this, function(ApiClient) {
    /**
     * The FDUserValueTransferTransactionRequest model module.
     * @class FDUserValueTransferTransactionRequest
     * @version 1.0
     */

    /**
     * Constructs a new <code>FDUserValueTransferTransactionRequest</code>.
     * User Fee Delegation KLAY Transfer Transaction Request Scheme
     * @alias FDUserValueTransferTransactionRequest
     * @class
     * @param from {String} Klaytn account address sending a transaction
     * @param value {String} KLAY converted into PEB unit
     * @param to {String} Klaytn account address to receive KLAY
     * @param feePayer {String} Account address for fee delegation of transaction fee
     */
    const FDUserValueTransferTransactionRequest = function(from, value, to, feePayer) {
        this.from = from
        this.value = value
        this.to = to
    ...
    FDUserValueTransferTransactionRequest.constructFromObject = function(data, obj) {
        if (data) {
            obj = obj || new FDUserValueTransferTransactionRequest()
     ...
     * @default 100000
     */
    FDUserValueTransferTransactionRequest.prototype.gas = 100000
    ...
    return FDUserValueTransferTransactionRequest
})
