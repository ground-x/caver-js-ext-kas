...
;(function(root, factory) {
     ...
     * @class
     * @param signedWeight {Number} Sum of weight after this signer signed
     * @param status {String} Current transaction status
     ...
     * @param weight {Number} Weight of this signer
     */
