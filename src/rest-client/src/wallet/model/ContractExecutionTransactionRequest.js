...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.ContractExecutionTransactionRequest = factory(root.WalletApi.ApiClient)
    }
     ...
     * Contract execution transaction request schema.
     ...
     */
    const ContractExecutionTransactionRequest = function(from, to, input) {
        this.from = from
        this.to = to
        this.input = input
    }
    ...
    ContractExecutionTransactionRequest.constructFromObject = function(data, obj) {
        if (data) {
            obj = obj || new ContractExecutionTransactionRequest()
    ...
    return ContractExecutionTransactionRequest
})
