...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.AccountByPubkey = factory(root.WalletApi.ApiClient)
    }
})(this, function(ApiClient) {
    /**
     * The AccountByPubkey model module.
     * @class AccountByPubkey
     * @version 1.0
     */

    /**
     * Constructs a new <code>AccountByPubkey</code>.
     * Account associated with the requested public key
     * @alias AccountByPubkey
     * @class
     * @param address {String} Klaytn account address
     * @param chainId {Number} Klaytn chain ID
     */
    const AccountByPubkey = function(address, chainId) {
