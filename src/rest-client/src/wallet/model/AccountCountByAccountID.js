...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.AccountCountByAccountID = factory(root.WalletApi.ApiClient)
    }
     ...
     * @param count {Number} Number of Klaytn accounts and keys on the KAS account
     */
    const AccountCountByAccountID = function(accountId, count) {
    ...
    AccountCountByAccountID.constructFromObject = function(data, obj) {
        if (data) {
            obj = obj || new AccountCountByAccountID()
