...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.MultisigAccountUpdateRequest = factory(root.WalletApi.ApiClient, root.WalletApi.MultisigKey)
    }
     ...
     * Request Scheme for Updating to Multisig Account
     * @alias MultisigAccountUpdateRequest
     * @class
     * @param threshold {Number} Reference value for total weight validation
    ...
    MultisigAccountUpdateRequest.constructFromObject = function(data, obj) {
        if (data) {
            obj = obj || new MultisigAccountUpdateRequest()
            if (data.hasOwnProperty('threshold')) obj.threshold = ApiClient.convertToType(data.threshold, 'Number')
            if (data.hasOwnProperty('weightedKeys')) obj.weightedKeys = ApiClient.convertToType(data.weightedKeys, [MultisigKey])
        }
        return obj
    }

    /**
     * Reference value for total weight validation
     * @type {Number}
     * @memberof MultisigAccountUpdateRequest
     */
    ...
    return MultisigAccountUpdateRequest
})
