...
class MultisigAccountUpdateRequest {
    ...
    constructor(threshold, weightedKeys) {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('weightedKeys')) {
                obj.weightedKeys = ApiClient.convertToType(data.weightedKeys, [MultisigKey])
            }
        }
        return obj
    }
...
module.exports = MultisigAccountUpdateRequest
