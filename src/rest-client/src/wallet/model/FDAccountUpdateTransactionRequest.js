...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.FDAccountUpdateTransactionRequest = factory(root.WalletApi.ApiClient)
    }
     ...
     * Fee Delegation Account Update Transaction Request Scheme
     * @alias FDAccountUpdateTransactionRequest
     * @class
     * @param from {String} Klaytn account address sending a transaction
     */
    const FDAccountUpdateTransactionRequest = function(from) {
        this.from = from
    }
    ...
    FDAccountUpdateTransactionRequest.constructFromObject = function(data, obj) {
        if (data) {
            obj = obj || new FDAccountUpdateTransactionRequest()
    ...
    return FDAccountUpdateTransactionRequest
})
