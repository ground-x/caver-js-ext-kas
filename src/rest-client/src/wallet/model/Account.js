...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['../../ApiClient', '../model/MultisigKey'], factory)
    } else if (typeof module === 'object' && module.exports) {
        // CommonJS-like environments that support module.exports, like Node.
        module.exports = factory(require('../../ApiClient'), require('./MultisigKey'))
    } else {
        // Browser globals (root is window)
        if (!root.WalletApi) {
            root.WalletApi = {}
        }
        root.WalletApi.Account = factory(root.WalletApi.ApiClient, root.WalletApi.MultisigKey)
    }
     ...
     * @param createdAt {Number} Timestamp of Klaytn account creation
     * @param keyId {String} Private key ID of the account
     * @param krn {String} KAS KRN
     * @param publicKey {String} Public key of the account
     * @param updatedAt {Number} Timestamp when account information was last updated
     */
    const Account = function(address, chainId, createdAt, keyId, krn, publicKey, updatedAt) {
    ...
    Account.constructFromObject = function(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('multiSigKeys')) obj.multiSigKeys = ApiClient.convertToType(data.multiSigKeys, [MultisigKey])
