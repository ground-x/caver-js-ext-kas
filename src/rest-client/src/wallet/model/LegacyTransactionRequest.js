...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.LegacyTransactionRequest = factory(root.WalletApi.ApiClient)
    }
    ...
    return LegacyTransactionRequest
})
