...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.FDProcessRLPRequest = factory(root.WalletApi.ApiClient)
    }
     ...
     * Fee Delegation Transaction Request Scheme Using RLP
     * @alias FDProcessRLPRequest
     * @class
     * @param rlp {String} The RLP value is used to receive a Klaytn RLP format (SigRLP or TxHashRLP). This scheme just allow (partial) fee delegation transaction type.
     */
    const FDProcessRLPRequest = function(rlp) {
        this.rlp = rlp
    }
