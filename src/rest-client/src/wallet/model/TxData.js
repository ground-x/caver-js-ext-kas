...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.TxData = factory(root.WalletApi.ApiClient)
    }
     ...
     * Pratical transaction data of multisig transaction
     * @alias TxData
     * @class
     * @param from {String} Multisig account address
     * @param gas {Number} Max. transaction fee (gas) for sending the transaction
     * @param gasPrice {String} Transaction fee (gas) for sending the transaction
     * @param typeInt {Number} Numeric value of transaction type
     */
    const TxData = function(from, gas, gasPrice, typeInt) {
        this.from = from
        this.gas = gas
