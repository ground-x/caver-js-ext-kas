...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.MultisigAddress = factory(root.WalletApi.ApiClient)
    }
     ...
     * Multisig-associated account
     * @alias MultisigAddress
     * @class
     * @param address {String} Multisig associated account address
     * @param weight {Number} Weight of Multisig associated account
     */
    const MultisigAddress = function(address, weight) {
