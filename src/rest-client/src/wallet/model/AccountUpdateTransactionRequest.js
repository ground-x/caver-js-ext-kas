...
const AccountUpdateKey = require('./AccountUpdateKey')
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('accountKey')) {
                obj.accountKey = ApiClient.convertToType(data.accountKey, Object)
            }
...
module.exports = AccountUpdateTransactionRequest
