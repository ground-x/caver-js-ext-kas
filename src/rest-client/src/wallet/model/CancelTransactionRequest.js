...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.CancelTransactionRequest = factory(root.WalletApi.ApiClient)
    }
     ...
     */
    const CancelTransactionRequest = function(from) {
        this.from = from
    }
    ...
    CancelTransactionRequest.constructFromObject = function(data, obj) {
        if (data) {
            obj = obj || new CancelTransactionRequest()
