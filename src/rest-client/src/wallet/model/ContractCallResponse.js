...
class ContractCallResponse {
     ...
     * Calls contract response schema
     * @alias ContractCallResponse
     * @class
     * @param data {String} Called contract data
     * @param result {String} Response
     */
...
module.exports = ContractCallResponse
