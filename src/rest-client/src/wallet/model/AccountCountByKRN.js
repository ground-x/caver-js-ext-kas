...
class AccountCountByKRN {
     ...
     * @param count {Number} Number of Klaytn accounts on a certain account repository
     * @param krn {String} KAS KRN(Name of account repository)
     */

    constructor(accountId, count, krn) {
...
module.exports = AccountCountByKRN
