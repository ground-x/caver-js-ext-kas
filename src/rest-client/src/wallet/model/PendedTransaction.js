...
;(function(root, factory) {
     ...
     * @param status {Number} 트랜잭션의 현재 상태
     * @param threshold {Number} 이 트랜잭션이 전송되는 데 필요한 가중치 총합
     * @param transactionId {String} 다중 서명 트랜잭션을 식별하는 ID
     * @param updatedAt {Number} 해당 트랜잭션이 최종 업데이트 된 시간
     */
    const PendedTransaction = function(chainId, createdAt, status, threshold, transactionId, updatedAt) {
