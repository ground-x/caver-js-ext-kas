...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['../../ApiClient', '../model/MultisigAddress', '../model/TxData'], factory)
    } else if (typeof module === 'object' && module.exports) {
        // CommonJS-like environments that support module.exports, like Node.
        module.exports = factory(require('../../ApiClient'), require('./MultisigAddress'), require('./TxData'))
    } else {
        // Browser globals (root is window)
        if (!root.WalletApi) {
            root.WalletApi = {}
        }
        root.WalletApi.PendedTransaction = factory(root.WalletApi.ApiClient, root.WalletApi.MultisigAddress, root.WalletApi.TxData)
    }
     ...
     * @param createdAt {Number} Transaction request timestamp
     * @param status {Number} Current transaction status
     * @param threshold {Number} Total weight required for sending the transaction
     * @param transactionId {String} ID for multisig transactions
     * @param txData {TxData}
     * @param updatedAt {Number} Time when the transaction was last updated
     */
    const PendedTransaction = function(address, chainId, createdAt, status, threshold, transactionId, txData, updatedAt) {
    ...
    PendedTransaction.constructFromObject = function(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('chainId')) obj.chainId = ApiClient.convertToType(data.chainId, 'Number')
            if (data.hasOwnProperty('createdAt')) obj.createdAt = ApiClient.convertToType(data.createdAt, 'Number')
            if (data.hasOwnProperty('multiSigKeys')) obj.multiSigKeys = ApiClient.convertToType(data.multiSigKeys, [MultisigAddress])
            if (data.hasOwnProperty('status')) obj.status = ApiClient.convertToType(data.status, 'Number')
            ...
            if (data.hasOwnProperty('txData')) obj.txData = TxData.constructFromObject(data.txData)
