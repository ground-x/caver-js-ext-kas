...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.MultisigAccount = factory(root.WalletApi.ApiClient, root.WalletApi.MultisigKey)
    }
     ...
     * @param threshold {Number} Total weight required for multisig transactions
     * @param transactionHash {String} Transaction hash for updating account information
     * @param updatedAt {Number} Time when account information was last updated
     */
    const MultisigAccount = function(address, krn, threshold, transactionHash, updatedAt) {
