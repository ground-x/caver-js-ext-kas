...
const RegistrationFailure = require('./RegistrationFailure')
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('failures')) {
                obj.failures = RegistrationFailure.constructFromObject(data.failures)
            }
        }
        return obj
    }
...
module.exports = RegistrationStatusResponse
