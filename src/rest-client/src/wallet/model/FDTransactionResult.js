...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.FDTransactionResult = factory(root.WalletApi.ApiClient, root.WalletApi.Signature)
    }
     ...
     */
    const FDTransactionResult = function(feePayer, from, gas, gasPrice, nonce, rlp, typeInt) {
