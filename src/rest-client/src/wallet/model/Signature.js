...
;(function(root, factory) {
     ...
     * @alias Signature
     * @class
     * @param R {String} ECDSA signature information
     * @param S {String} ECDSA signature information
     * @param V {String} Public key restoration information
     */
    ...
    /**
     * Public key restoration information
     * @type {String}
     * @memberof Signature
     */
