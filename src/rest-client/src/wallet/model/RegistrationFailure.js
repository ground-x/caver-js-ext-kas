...
/**
 * The RegistrationFailure model module.
 * @class RegistrationFailure
 * @version 1.0
 */
class RegistrationFailure {
    /**
     * Constructs a new <code>RegistrationFailure</code>.
     * Registration failed addresses and causes.
     * @alias RegistrationFailure
     * @class
     * @extends Object
     */
    ...
    /**
     * Constructs a <code>RegistrationFailure</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {RegistrationFailure} obj Optional instance to populate.
     * @return {RegistrationFailure} The populated <code>RegistrationFailure</code> instance.
     * @memberof RegistrationFailure
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RegistrationFailure()
...
module.exports = RegistrationFailure
