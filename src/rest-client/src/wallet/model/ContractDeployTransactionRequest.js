...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.ContractDeployTransactionRequest = factory(root.WalletApi.ApiClient)
    }
     ...
     */
    const ContractDeployTransactionRequest = function(from, input) {
        this.from = from
        this.input = input
    }
    ...
    return ContractDeployTransactionRequest
})
