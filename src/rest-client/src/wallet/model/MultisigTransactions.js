...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['../../ApiClient', '../model/PendedTransaction'], factory)
    } else if (typeof module === 'object' && module.exports) {
        // CommonJS-like environments that support module.exports, like Node.
        module.exports = factory(require('../../ApiClient'), require('./PendedTransaction'))
    } else {
        // Browser globals (root is window)
        if (!root.WalletApi) {
            root.WalletApi = {}
        }
        root.WalletApi.MultisigTransactions = factory(root.WalletApi.ApiClient, root.WalletApi.PendedTransaction)
    }
    ...
    MultisigTransactions.constructFromObject = function(data, obj) {
        if (data) {
            obj = obj || new MultisigTransactions()
            if (data.hasOwnProperty('cursor')) obj.cursor = ApiClient.convertToType(data.cursor, 'String')
            if (data.hasOwnProperty('items')) obj.items = ApiClient.convertToType(data.items, [PendedTransaction])
        }
        return obj
    }
