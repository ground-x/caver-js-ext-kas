...
const CallArgument = require('./CallArgument')
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('arguments')) {
                obj.arguments = ApiClient.convertToType(data.arguments, [CallArgument])
            }
        }
        return obj
    }
 ...
 * @memberof ContractCallData
 */
ContractCallData.prototype.arguments = undefined

module.exports = ContractCallData
