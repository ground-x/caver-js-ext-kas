...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.MultisigUpdateKey = factory(root.WalletApi.ApiClient, root.WalletApi.MultisigKey)
    }
})(this, function(ApiClient, MultisigKey) {
    /**
     * The MultisigUpdateKey model module.
     * @class MultisigUpdateKey
     * @version 1.0
     */
     ...
     * @memberof MultisigUpdateKey
     */
    MultisigUpdateKey.constructFromObject = function(data, obj) {
        if (data) {
            obj = obj || new MultisigUpdateKey()
    ...
    /**
     * Threshold for validating weighed values
     * @type {Number}
     * @memberof MultisigUpdateKey
     */
