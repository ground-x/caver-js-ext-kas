...
class KeySignDataResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('signedData')) {
                obj.signedData = ApiClient.convertToType(data.signedData, 'String')
            }
        }
        return obj
    }
...
module.exports = KeySignDataResponse
