...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['../../ApiClient', '../model/AccountByPubkey'], factory)
    } else if (typeof module === 'object' && module.exports) {
        // CommonJS-like environments that support module.exports, like Node.
        module.exports = factory(require('../../ApiClient'), require('./AccountByPubkey'))
    } else {
        // Browser globals (root is window)
        if (!root.WalletApi) {
            root.WalletApi = {}
        }
        root.WalletApi.AccountsByPubkey = factory(root.WalletApi.ApiClient, root.WalletApi.AccountByPubkey)
    }
     ...
     * List of accounts with public keys
    ...
    AccountsByPubkey.constructFromObject = function(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) obj.items = ApiClient.convertToType(data.items, [AccountByPubkey])
        }
        return obj
    }
