...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.ProcessRLPRequest = factory(root.WalletApi.ApiClient)
    }
     ...
     * Transaction request schema using RLP
     * @alias ProcessRLPRequest
     * @class
     * @param rlp {String} The RLP value is used to receive a Klaytn RLP format (SigRLP or TxHashRLP). This scheme just allow legacy and basic transaction type.
     */
    const ProcessRLPRequest = function(rlp) {
        this.rlp = rlp
    }
