...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.FDAnchorTransactionRequest = factory(root.WalletApi.ApiClient)
    }
     ...
     * Fee Delegation Anchoring Transaction Request Scheme
     ...
     */
    const FDAnchorTransactionRequest = function(from, input) {
        this.from = from
        this.input = input
    }
    ...
    FDAnchorTransactionRequest.constructFromObject = function(data, obj) {
        if (data) {
            obj = obj || new FDAnchorTransactionRequest()
    ...
    return FDAnchorTransactionRequest
})
