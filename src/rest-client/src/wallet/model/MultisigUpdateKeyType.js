...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['../../ApiClient', '../model/MultisigUpdateKey'], factory)
    } else if (typeof module === 'object' && module.exports) {
        // CommonJS-like environments that support module.exports, like Node.
        module.exports = factory(require('../../ApiClient'), require('./MultisigUpdateKey'))
    } else {
        // Browser globals (root is window)
        if (!root.WalletApi) {
            root.WalletApi = {}
        }
        root.WalletApi.MultisigUpdateKeyType = factory(root.WalletApi.ApiClient, root.WalletApi.MultisigUpdateKey)
    }
    ...
    MultisigUpdateKeyType.constructFromObject = function(data, obj) {
        if (data) {
            obj = obj || new MultisigUpdateKeyType()
            if (data.hasOwnProperty('keyType')) obj.keyType = ApiClient.convertToType(data.keyType, 'Number')
            if (data.hasOwnProperty('key')) obj.key = MultisigUpdateKey.constructFromObject(data.key)
        }
        return obj
    }
