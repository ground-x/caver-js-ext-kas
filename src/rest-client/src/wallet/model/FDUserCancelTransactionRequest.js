...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.WalletApi.FDUserCancelTransactionRequest = factory(root.WalletApi.ApiClient)
    }
     ...
     * Cancel User Fee Delegation transaction request schema
     ...
     */
    const FDUserCancelTransactionRequest = function(from, feePayer) {
        this.from = from
    ...
    FDUserCancelTransactionRequest.constructFromObject = function(data, obj) {
        if (data) {
            obj = obj || new FDUserCancelTransactionRequest()
    ...
    return FDUserCancelTransactionRequest
})
