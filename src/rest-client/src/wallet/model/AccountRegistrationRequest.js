...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['../../ApiClient', '../model/AccountRegistration'], factory)
    } else if (typeof module === 'object' && module.exports) {
        // CommonJS-like environments that support module.exports, like Node.
        module.exports = factory(require('../../ApiClient'), require('./AccountRegistration'))
    } else {
        // Browser globals (root is window)
        if (!root.WalletApi) {
            root.WalletApi = {}
        }
        root.WalletApi.AccountRegistrationRequest = factory(root.WalletApi.ApiClient, root.WalletApi.AccountRegistration)
    }
})(this, function(ApiClient, AccountRegistration) {
    /**
     ...
     * Account Registeration Request Schema
     * @alias AccountRegistrationRequest
     * @class
     */
    const AccountRegistrationRequest = function() {}
     ...
     * @param {AccountRegistrationRequest} obj Optional instance to populate.
     * @return {AccountRegistrationRequest} The populated <code>AccountRegistrationRequest</code> instance.
     * @memberof AccountRegistrationRequest
     */
    AccountRegistrationRequest.constructFromObject = function(data, obj) {
        if (data) {
            obj = obj || new AccountRegistrationRequest()
            if (data.hasOwnProperty('items')) obj.items = ApiClient.convertToType(data.items, [AccountRegistration])
        }
        return obj
    }

    /**
     * @type {Array.<AccountRegistration>}
     * @memberof AccountRegistrationRequest
     */
    AccountRegistrationRequest.prototype.items = undefined
