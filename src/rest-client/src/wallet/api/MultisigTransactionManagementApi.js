...
;(function(root, factory) {
    ...
    const exports = function(apiClient) {
         ...
         * @param {String} address 다중 서명 키를 가진 계정 주소 또는 서명자 계정 주소
         * @param {Object} opts Optional parameters
         * @param {Number} opts.size 불러올 트랜잭션의 최대 개수 (default: 100, min:1, max:-)
         * @param {String} opts.cursor 마지막 검색 위치를 나타내는 커서 정보
         * @param {Number} opts.toTimestamp 검색 범위: 시작 시간의 타임스탬프 (초단위)
         * @param {Number} opts.fromTimestamp 검색 범위: 마지막 시간의 타임스탬프 (초단위)
