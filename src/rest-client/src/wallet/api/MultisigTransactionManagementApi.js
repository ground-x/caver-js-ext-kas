...
;(function(root, factory) {
    ...
    const MultisigTransactionManagementApi = function(apiClient) {
         ...
         * @param {String} address Account address or user's account address with multisig keys
         * @param {Object} opts Optional parameters
         * @param {Number} opts.size Maximum size of the accounts to be queried (default to 100)
         ...
         * @param {String} transactionId Pending transaction ID
