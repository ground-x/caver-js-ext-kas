...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.Kip17Api.Kip17ContractListResponseItem = factory(root.Kip17Api.ApiClient)
    }
     ...
     */
    const Kip17ContractListResponseItem = function(address, alias, name, symbol) {
     ...
     */
    Kip17ContractListResponseItem.constructFromObject = function(data, obj) {
        if (data) {
    ...
    return Kip17ContractListResponseItem
})
