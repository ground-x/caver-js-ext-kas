...
class GetKip17TokenHistoryResponseItem {
     ...
     * @class
     * @param from {String} The Klaytn account address of the sender.
     * @param timestamp {Number} The UNIX timestamp of when the ownership changed.
     * @param to {String} The Klaytn account address of the recipient.
     */
