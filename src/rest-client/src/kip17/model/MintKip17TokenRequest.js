...
class MintKip17TokenRequest {
     ...
     * @class
     * @param to {String} The Klaytn accound address of the new token's owner.
     * @param id {String} The ID of the new token; it must not be a duplicate of an existing ID.
     * @param uri {String} The URI of the new token.
     */
