...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.Kip7Api.ApproveKip7TokenRequest = factory(root.Kip7Api.ApiClient)
    }
     ...
     */
    const ApproveKip7TokenRequest = function(spender, amount) {
     ...
     */
    ApproveKip7TokenRequest.constructFromObject = function(data, obj) {
        if (data) {
    ...
    return ApproveKip7TokenRequest
})
