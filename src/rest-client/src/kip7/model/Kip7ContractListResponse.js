...
const Kip7ContractListResponseItem = require('./Kip7ContractListResponseItem')
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj.items = ApiClient.convertToType(data.items, [Kip7ContractListResponseItem])
            }
...
module.exports = Kip7ContractListResponse
