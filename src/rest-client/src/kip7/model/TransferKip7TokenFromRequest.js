...
class TransferKip7TokenFromRequest {
     ...
     * @class
     * @param spender {String} The Klaytn account address to send tokens on behalf of the `owner`.
     * @param owner {String} The Klaytn account address of the owner granting the authority to send tokens on his or her behalf.
     * @param to {String} Klaytn account address to receive tokens
     * @param amount {String} Transfer amount (in hex.)
     */
