...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.Kip7Api.Kip7ContractMetadataResponse = factory(root.Kip7Api.ApiClient)
    }
})(this, function(ApiClient) {
    /**
     * The Kip7ContractMetadataResponse model module.
     * @class Kip7ContractMetadataResponse
     * @version 1.0
     */

    /**
     * Constructs a new <code>Kip7ContractMetadataResponse</code>.
     * @alias Kip7ContractMetadataResponse
     * @class
     ...
     */
    const Kip7ContractMetadataResponse = function(address, decimals, name, symbol, totalSupply) {
    ...
    /**
     * Constructs a <code>Kip7ContractMetadataResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {Kip7ContractMetadataResponse} obj Optional instance to populate.
     * @return {Kip7ContractMetadataResponse} The populated <code>Kip7ContractMetadataResponse</code> instance.
     * @memberof Kip7ContractMetadataResponse
     */
    Kip7ContractMetadataResponse.constructFromObject = function(data, obj) {
        if (data) {
            obj = obj || new Kip7ContractMetadataResponse()
     ...
     * @memberof Kip7ContractMetadataResponse
     */
    Kip7ContractMetadataResponse.prototype.address = undefined
     ...
     * @memberof Kip7ContractMetadataResponse
     */
    Kip7ContractMetadataResponse.prototype.decimals = undefined
     ...
     * @memberof Kip7ContractMetadataResponse
     */
    Kip7ContractMetadataResponse.prototype.name = undefined
     ...
     * @memberof Kip7ContractMetadataResponse
     */
    Kip7ContractMetadataResponse.prototype.symbol = undefined
     ...
     * @memberof Kip7ContractMetadataResponse
     */
    Kip7ContractMetadataResponse.prototype.totalSupply = undefined
