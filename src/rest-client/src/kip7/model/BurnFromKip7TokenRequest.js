...
class BurnFromKip7TokenRequest {
     ...
     * @class
     * @param owner {String} The Klaytn account address of the owner of the tokens to be burned.
     * @param spender {String} The Klaytn account address whose authorized tokens will be burned.
