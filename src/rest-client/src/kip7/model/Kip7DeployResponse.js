 ...
 * @class Kip7DeployResponse
 * @version 1.0
 */
class Kip7DeployResponse {
    /**
     * Constructs a new <code>Kip7DeployResponse</code>.
     * @alias Kip7DeployResponse
     * @class
    ...
    /**
     * Constructs a <code>Kip7DeployResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {Kip7DeployResponse} obj Optional instance to populate.
     * @return {Kip7DeployResponse} The populated <code>Kip7DeployResponse</code> instance.
     * @memberof Kip7DeployResponse
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Kip7DeployResponse()
 ...
 * @memberof Kip7DeployResponse
 */
Kip7DeployResponse.prototype.status = undefined
/**
 * Transaction hash
 * @type {String}
 * @memberof Kip7DeployResponse
...
module.exports = Kip7DeployResponse
