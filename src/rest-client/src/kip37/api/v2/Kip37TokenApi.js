...
class Kip37TokenApi {
    ...
    /**
     * Burn Tokens
     * Burns specified tokens minted from a KIP-37 contract. You can select the number and the amount of tokens burn.    ##### From The account that sends the transaction.  You can omit the KRN if the &#x60;from&#x60; address is managed by KIP-37 or Wallet Service &#x60;account-pool&#x60;.&lt;br /&gt; Otherwise you have to provide the KRN object in the header (&#x60;x-krn: krn:{chain-id}:wallet:{account-id}:account-pool:{pool name}&#x60;).  ##### Batch Items It is possible to send different tokens in different amounts. Different functions will be called according to the number of Batch Items (&#x60;ids&#x60;, &#x60;amounts&#x60;) in the request.  - One element: the &#x60;burn&#x60; function - Multiple elements: the &#x60;burnBatch&#x60; function
