...
/**
 * The Kip37ContractOwnerResponse model module.
 * @class Kip37ContractOwnerResponse
 * @version 1.0
 */
class Kip37ContractOwnerResponse {
    /**
     * Constructs a new <code>Kip37ContractOwnerResponse</code>.
     * @alias Kip37ContractOwnerResponse
     * @class
     * @param owner {String} The address of the owner who owns the contract.
     */
    ...
    /**
     * Constructs a <code>Kip37ContractOwnerResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {Kip37ContractOwnerResponse} obj Optional instance to populate.
     * @return {Kip37ContractOwnerResponse} The populated <code>Kip37ContractOwnerResponse</code> instance.
     * @memberof Kip37ContractOwnerResponse
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Kip37ContractOwnerResponse()
...
/**
 * The address of the owner who owns the contract.
 * @type {String}
 * @memberof Kip37ContractOwnerResponse
 */
Kip37ContractOwnerResponse.prototype.owner = undefined

module.exports = Kip37ContractOwnerResponse
