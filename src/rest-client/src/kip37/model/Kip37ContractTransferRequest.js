...
/**
 * The Kip37ContractTransferRequest model module.
 * @class Kip37ContractTransferRequest
 * @version 1.0
 */
class Kip37ContractTransferRequest {
    /**
     * Constructs a new <code>Kip37ContractTransferRequest</code>.
     * @alias Kip37ContractTransferRequest
     * @class
     * @param owner {String} The contract ownership is transferred to the relevant address.
     */
    ...
    /**
     * Constructs a <code>Kip37ContractTransferRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {Kip37ContractTransferRequest} obj Optional instance to populate.
     * @return {Kip37ContractTransferRequest} The populated <code>Kip37ContractTransferRequest</code> instance.
     * @memberof Kip37ContractTransferRequest
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Kip37ContractTransferRequest()
 ...
 * @memberof Kip37ContractTransferRequest
 */
Kip37ContractTransferRequest.prototype.sender = undefined
/**
 * The contract ownership is transferred to the relevant address.
 * @type {String}
 * @memberof Kip37ContractTransferRequest
 */
Kip37ContractTransferRequest.prototype.owner = undefined

module.exports = Kip37ContractTransferRequest
