...
const Kip37TokenInfoListResponseItem = require('./Kip37TokenInfoListResponseItem')
...
class Kip37TokenInfoListResponse {
    /**
     * Constructs a new <code>Kip37TokenInfoListResponse</code>.
     * @alias Kip37TokenInfoListResponse
     * @class
     * @param items {Array.<Kip37TokenInfoListResponseItem>}
    ...
    /**
     * Constructs a <code>Kip37TokenInfoListResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {Kip37TokenInfoListResponse} obj Optional instance to populate.
     * @return {Kip37TokenInfoListResponse} The populated <code>Kip37TokenInfoListResponse</code> instance.
     * @memberof Kip37TokenInfoListResponse
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Kip37TokenInfoListResponse()

            if (data.hasOwnProperty('items')) {
                obj.items = ApiClient.convertToType(data.items, [Kip37TokenInfoListResponseItem])
            }
...
/**
 * @type {Array.<Kip37TokenInfoListResponseItem>}
 * @memberof Kip37TokenInfoListResponse
 */
Kip37TokenInfoListResponse.prototype.items = undefined
/**
 * The pointer for the next request, after which the result will be returned.
 * @type {String}
 * @memberof Kip37TokenInfoListResponse
 */
Kip37TokenInfoListResponse.prototype.cursor = undefined

module.exports = Kip37TokenInfoListResponse
