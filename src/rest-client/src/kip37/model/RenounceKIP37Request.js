...
/**
 * The RenounceKIP37Request model module.
 * @class RenounceKIP37Request
 * @version 1.0
 */
class RenounceKIP37Request {
    /**
     * Constructs a new <code>RenounceKIP37Request</code>.
     * @alias RenounceKIP37Request
     * @class
     */

    /**
     * Constructs a <code>RenounceKIP37Request</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {RenounceKIP37Request} obj Optional instance to populate.
     * @return {RenounceKIP37Request} The populated <code>RenounceKIP37Request</code> instance.
     * @memberof RenounceKIP37Request
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RenounceKIP37Request()
 ...
 * @memberof RenounceKIP37Request
 */
RenounceKIP37Request.prototype.from = undefined

module.exports = RenounceKIP37Request
