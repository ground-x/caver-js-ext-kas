...
;(function(root, factory) {
    ...
    const TokenContractApi = function(apiClient) {
         ...
         * Retrieve information for all labeled NFT contracts.  ## Size  * The `size` query parameter is optional (minimum = 1, maximum = 1000, default = 100). * Submitting negative values result in errors. * Submitting zero results in a query with `size=100`, which is the default value. * Submitting values greater than 1000 result in queries with `size=1000`, which is the maximum value.
         * @param {String} xChainId Klaytn network chain ID (1001 or 8217)
         ...
         * Retrieve information for all labeled FT contracts.  ## Size  * The `size` query parameter is optional (minimum = 1, maximum = 1000, default = 100). * Submitting negative values result in errors. * Submitting zero results in a query with `size=100`, which is the default value. * Submitting values greater than 1000 result in queries with `size=1000`, which is the maximum value.
         * @param {String} xChainId Klaytn network chain ID (1001 or 8217)
         * @param {Object} opts Optional parameters
         * @param {String} opts.status Labeling status [completed, processing, failed, cancelled]
