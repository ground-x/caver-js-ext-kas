...
;(function(root, factory) {
    ...
    const TokenContractApi = function(apiClient) {
         ...
         * @param {String} opts.type Contract type  [KIP-37, ERC-1155]; return both if not specified
         * @param {Number} opts.size Number of items to return (min=1, max=1000, default=100)
         * @param {String} opts.cursor Offset for the next batch of items (pagination)
