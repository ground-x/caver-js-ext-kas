...
;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['superagent', 'querystring', './ErrorResponse'], factory)
    } else if (typeof module === 'object' && module.exports) {
        // CommonJS-like environments that support module.exports, like Node.
        module.exports = factory(require('superagent'), require('querystring'), require('./ErrorResponse'))
    } else {
        // Browser globals (root is window)
        if (!root.AnchorApi) {
            root.AnchorApi = {}
        }
        if (!root.KasTokenHistoryApiV070) {
            root.KasTokenHistoryApiV070 = {}
        }
        root.AnchorApi.ApiClient = factory(root.superagent, root.querystring)
        root.KasTokenHistoryApiV070.ApiClient = factory(root.superagent, root.querystring)
        root.ErrorResponse = factory(root.ErrorResponse)
    }
