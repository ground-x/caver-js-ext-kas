...
class KIP17FeePayerOptions {
    /**
     * Create an instance of KIP17FeePayerOptions from object. <br>
     * You can use object instead of KIP17FeePayerOptions instance when using `caver.kas.kip17`. <br>
     * Because the function of `caver.kas.kip17` internally converts object to KIP17FeePayerOptions instance,
