...
class Wallet {
     ...
     * @property {number} nonce - Indicates nonce for a transaction
    ...
    async migrateAccounts(accounts) {
        ...
        const keyCreate = () => {
            return new Promise((resolve, reject) => {
                this.keyApi.keyCreation(chainId, { body: { size: accounts.length } }, (err, data, response) => {
                    if (err) {
                        reject(err)
                    }
                    resolve(data)
        ...
        return new Promise((resolve, reject) => {
            this.registrationApi.registerAccount(chainId, { body: req }, (err, data, response) => {
                if (err) {
                    reject(err)
                }
                resolve(data)
