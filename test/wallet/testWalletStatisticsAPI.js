...
//             const getCreateAccountSpy = sandbox.spy(caver.kas.wallet.statisticsApi, 'getCreateAccount')
...
//             const getCreateAccountSpy = sandbox.spy(caver.kas.wallet.statisticsApi, 'getCreateAccount1')
//             const callApiStub = sandbox.stub(caver.kas.wallet.statisticsApi.apiClient, 'callApi')
//             setCallFakeForCallApi(callApiStub)

//             const ret = await caver.kas.wallet.countAccountsByKRN(krn)
